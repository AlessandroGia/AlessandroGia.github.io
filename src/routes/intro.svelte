<script lang="ts">
    ...
    const birthday: string = '2001-09-24';
...
<div id="intro" in:fly={{y: 100, duration: 500}} style="width:{window_width}px; height:{window_height}px; background-color: transparent">
